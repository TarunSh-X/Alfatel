...
const inputClasses =
  "w-full rounded-lg bg-[#0D1F3C] border border-white/10 px-4 py-3 text-white placeholder:text-white/40 transition-all focus:outline-none focus:border-[#FFBE32] focus:ring-2 focus:ring-[#FFBE32]/30 focus:shadow-[0_0_18px_rgba(255,190,50,0.25)]"
              ...
              <div className="lg:col-span-2 rounded-2xl bg-[#0f2744] p-8 lg:p-10 text-white">
                ...
                <div className="mt-8 space-y-5">
                  <a
                    ...
                    className="flex items-center gap-4 text-white/80 hover:text-[#FFBE32] transition-colors group"
                  >
                    <span className="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center group-hover:bg-[#FFBE32]/20 transition-colors">
                ...
                {/* Office locations */}
                <div className="mt-10">
                  <h2 className="text-sm font-semibold uppercase tracking-wide text-[#FFBE32]">
                    Office Locations
                  </h2>
                    ...
                    {offices.map((office) => (
                      <div key={office.name} className="flex items-start gap-4">
                        <span className="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center shrink-0">
                          <MapPin className="w-5 h-5 text-[#FFBE32]" />
                        </span>
                ...
                <div className="mt-10 flex items-center gap-3">
                  <a
                    ...
                    aria-label="LinkedIn"
                    className="w-11 h-11 rounded-lg bg-white/10 flex items-center justify-center text-white/80 hover:text-[#FFBE32] hover:bg-[#FFBE32]/20 transition-all"
                  >
                  ...
                  <form onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="mt-8 grid sm:grid-cols-2 gap-5">
                      ...
                      <div>
                        <label htmlFor="fullName" className="block text-sm font-medium text-white/80 mb-1.5">
                          Full Name <span className="text-[#FFBE32]">*</span>
                        </label>
                        <input
                          id="fullName"
                          type="text"
                      ...
                      <div>
                        <label htmlFor="email" className="block text-sm font-medium text-white/80 mb-1.5">
                          Email Address <span className="text-[#FFBE32]">*</span>
                        </label>
                        <input
                          id="email"
                          type="email"
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex gap-2">
                          <select
                            ...
                            className="w-24 shrink-0 rounded-lg bg-[#0D1F3C] border border-white/10 px-3 py-3 text-white transition-all focus:outline-none focus:border-[#FFBE32] focus:ring-2 focus:ring-[#FFBE32]/30"
                          >
                    ...
                    <div className="mt-5">
                      <label htmlFor="subject" className="block text-sm font-medium text-white/80 mb-1.5">
                        Subject <span className="text-[#FFBE32]">*</span>
                      </label>
                      <select
                        id="subject"
                        value={form.subject}
                    ...
                    <div className="mt-5">
                      <label htmlFor="message" className="block text-sm font-medium text-white/80 mb-1.5">
                        Message <span className="text-[#FFBE32]">*</span>
                      </label>
                      <textarea
                        id="message"
                        rows={4}
                    ...
                    <div className="mt-5">
                      <label htmlFor="agree" className="flex items-start gap-3 text-sm text-white/70 cursor-pointer">
                        <input
                          ...
                          className="mt-0.5 h-4 w-4 rounded border-white/20 bg-[#0D1F3C] text-[#FFBE32] focus:ring-[#FFBE32]/40 accent-[#FFBE32]"
                          aria-invalid={!!errors.agree}
                        />
                        <span>
                          I agree to the{" "}
                          <a href="/privacy" className="text-[#FFBE32] hover:underline">
                            Privacy Policy
                          </a>{" "}
                          and{" "}
                          <a href="/terms" className="text-[#FFBE32] hover:underline">
                            Terms of Service
                          </a>
                          .
                        </span>
                    ...
                    <button
                      type="submit"
                      className="mt-8 w-full rounded-lg bg-[#FFBE32] px-6 py-3.5 font-bold text-[#0f2744] hover:bg-[#FFBE32]/90 transition-colors"
                    >
                      Send Message
                    </button>
                  </form>
