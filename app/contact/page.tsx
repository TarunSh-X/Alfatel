                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex gap-2">
                          <select
                            ...
                            className="w-28 shrink-0 rounded-lg bg-[#0D1F3C] border border-white/10 px-3 py-3 text-white transition-all focus:outline-none focus:border-[#b89850] focus:ring-2 focus:ring-[#b89850]/30"
                          >
                            {countryCodes.map((c) => (
                              <option key={c.label} value={c.code} className="bg-[#0D1F3C]">
                                {c.label}
                              </option>
                            ))}
                          </select>
