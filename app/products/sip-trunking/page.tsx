    ...
    <>
      ...
      <main>
        <PageHero
          ...
          eyebrowIcon={Radio}
          title="Scalable SIP Trunk Connections"
          highlightLastWord
          description="Connect your PBX to our global network with unlimited channels, automatic failover, and enterprise-grade security."
          align="left"
          breadcrumbs={[
            { name: "Home", href: "/" },
          ...
          highlights={["Unlimited Channels", "PBX Integration", "TLS Encryption", "99.99% Uptime"]}
        />
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="text-4xl font-bold text-[#0f2744] mb-2">{benefit.value}</div>
                ...
                <ol className="space-y-4">
                  {[
                    ...
                    <li key={step} className="flex items-start gap-4">
                      <span className="flex-shrink-0 w-8 h-8 rounded-full bg-[#0f2744]/10 flex items-center justify-center text-[#0f2744] font-semibold text-sm">
                        {index + 1}
                      </span>
